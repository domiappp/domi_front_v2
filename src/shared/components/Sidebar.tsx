...
import { useLogout } from "../../services/useAuth"; // 👈 importar hook
...
const Sidebar: React.FC = () => {
  ...
  // 1) Filtrar estáticos por permisos
  const items = useMemo(() => {
  ...
  return (
    <div className="w-[300px] h-screen bg-[#33C6BB] flex flex-col justify-between overflow-y-auto">
      <div>
        {/* Usuario */}
